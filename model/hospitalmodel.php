...
{
	//openDatabaseConnection allows the function to communicate with server using SQL.
    $db = openDatabaseConnection();
// select * from selects everything from a certain table, (inner) join takes records from multiple tables, and joins matching ones.
